...
@fl.task(enable_deck=True, container_image=visual_image, limits=fl.Resources(mem="10Gi", cpu="2", ephemeral_storage="20Gi")) 
def frame_renderer(uri: str) -> None:
    data = fl.FlyteFile.from_source(uri)
